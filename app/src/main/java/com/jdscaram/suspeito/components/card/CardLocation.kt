package com.jdscaram.suspeito.components.card
...
import com.jdscaram.suspeito.components.shapes.RoundedCornerSquare
...
fun CardLocationRow(
    ...
    ConstraintLayout(
        ...
        createVerticalChain(*refList.toTypedArray())
    }
}
...
fun CardLocation(
    ...
    var updatedModifier = modifier.fillMaxWidth()
